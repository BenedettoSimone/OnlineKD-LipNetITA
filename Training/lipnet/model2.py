...
class LipNet(object):
    ...
    def build(self):
        ...
        self.conv1 = tf.keras.layers.Conv3D(16, (3, 5, 5), strides=(1, 2, 2), kernel_initializer='he_normal', name='conv1')(self.zero1)
        ...
        self.conv2 = tf.keras.layers.Conv3D(32, (3, 5, 5), strides=(1, 1, 1), kernel_initializer='he_normal', name='conv2')(self.zero2)
        ...
        self.conv3 = tf.keras.layers.Conv3D(64, (3, 3, 3), strides=(1, 1, 1), kernel_initializer='he_normal',
        ...
        self.gru_1 = tf.keras.layers.Bidirectional(
            tf.compat.v1.keras.layers.GRU(128, return_sequences=True, kernel_initializer='Orthogonal', name='gru1'),
            merge_mode='concat')(self.resh1)
        self.gru_2 = tf.keras.layers.Bidirectional(
            tf.compat.v1.keras.layers.GRU(128, return_sequences=True, kernel_initializer='Orthogonal', name='gru2'),
